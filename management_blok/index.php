<?php include '/xampp/htdocs/management_blok/config.php'; ?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <?php } else { ?>
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownBenuButton1">
                                <li><a class="dropdown-item" href="admin">Dashbord Admin</a></li>
